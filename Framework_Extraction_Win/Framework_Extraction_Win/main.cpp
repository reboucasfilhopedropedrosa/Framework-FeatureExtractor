...
int main(){
    ...
    sprintf(desktopDataAdrs,"C:\\Users\\Wellington\\Desktop\\DB");// Local onde sera salvo os bancos de dados gerados
    initializeAddresses(0, methods, desktopDataAdrs);// 1 - MacOS | 0 - Windows
